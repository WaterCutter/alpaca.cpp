...
- 安装gcc运行时[MinGW](https://sourceforge.net/projects/mingw-w64/files/mingw-w64/mingw-w64-release/),此链接中选择MinGW-W64 GCC-8.1.0 x86_64-posix-seh下载，添加x86_64-8.1.0-release-posix-seh-rt_v6-rev0\mingw64\bin到系统路径Path即可（要记得重启以使之生效）
...
## Model Weight File Link
上面提到的ggml-alpaca-7b-q4.bin文件，可以通过这个链接下载，大小4GB左右。
[ggml-alpaca-7b-q4.bin](https://huggingface.co/Sosaka/Alpaca-native-4bit-ggml/blob/main/ggml-alpaca-7b-q4.bin)
